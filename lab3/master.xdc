...
# create_clock -period 10.000 --> defines clock period as 10 ns, 1/10 ns = 100 MHz
# -waveform [0.000 5.000] defines clock waveform --> rising edge at 0.000 ns and falling edge at 5.000ns., 50% duty cycle
...
set_property PACKAGE_PIN V13 [get_ports {check}]
...
##Buttons
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports stop]
...
##Pmod Header JB
## Pmod AMP2 Connections
#set_property PACKAGE_PIN A14 [get_ports {freq}]     # Connect AIN (JB1)
#set_property IOSTANDARD LVCMOS33 [get_ports {freq}]

#set_property PACKAGE_PIN A16 [get_ports {gain}]     # Connect GAIN (JB2)
#set_property IOSTANDARD LVCMOS33 [get_ports {gain}]

#set_property PACKAGE_PIN B16 [get_ports {shutdown}] # Connect ~SHUTDOWN (JB4)
#set_property IOSTANDARD LVCMOS33 [get_ports {shutdown}]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports {freq}];    # Reserved
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports {gain}];    # Reserved
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports {shutdown}];    # Reserved

#set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports {JB[2]}];    # Reserved
